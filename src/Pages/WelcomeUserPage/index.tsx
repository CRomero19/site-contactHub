    ...
    <StyledWelcomeUserPage>
      ...
      <div className="container__greetings">
        ...
        <ol>
          ...
          <li><strong>4. Comunicação Integrada:</strong> Comunique-se diretamente com seus contatos através da plataforma. Envie e-mails ou mensagens instantâneas para manter-se conectado. <span className="warning-text">(Em breve)</span></li>
